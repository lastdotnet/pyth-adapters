 ...
 */
contract PythAggregatorV3Standardized {
    ...
    function latestAnswer() public view virtual returns (int256) {
        PythStructs.Price memory priceFeed = pyth.getPriceUnsafe(priceId);
    ...
    {
        PythStructs.Price memory price = pyth.getPriceUnsafe(priceId);
        return (_roundId, _scalePriceTo8Decimals(price), price.publishTime, price.publishTime, _roundId);
    }
